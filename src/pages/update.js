    ...
    return (
        <div className='flex flex-col items-center justify-center'>
            <form>
                ...
                <input type="text" placeholder='Enter your names' value={fullName} className='w-96 h-12 border-2 pl-2'
                    onChange={e => setFullName(e.target.value)}></input><br></br>


                <label>Email</label><br></br>
                <input type="text" placeholder='Enter your E-mail' value={email} className='w-96 h-12 border-2 pl-2'
                onChange={e => setEmail(e.target.value)}></input><br></br>

                <label>Phone</label><br></br>
                <input type="text" placeholder='Enter your Phone number' value={phone} className='w-96 h-12 border-2 pl-2'
               onChange={e => setPhone(e.target.value)} ></input><br></br>
                ...
                <button className='w-96 h-12 border-2 mt-4 bg-black text-white' onClick={() => updateContact(contId)}>Save Changes</button>
            </form>
